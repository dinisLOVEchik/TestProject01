...
namespace TestProjectTest
{
    ...
    public class TestClass
    {
        ...
        public TestClass()
        {
            workingMethods = new WorkingMethods();
        }

        [Test]
        public void Test()
        {
            string fileName = "../TestingOutfile.txt";
        ...
        public void Test01()
        {
            var filePath = "../TestingOutfile.txt";
            
            Dictionary<string, DateTime> expected = new Dictionary<string, DateTime>("192.168.1.10", 2022-05-15 08:30:15;
                "10.0.0.5:2022-05-15 09:45:20",
                "172.16.0.3:2022-05-15 10:20:35",
                "192.168.0.20:2022-05-15 11:15:40",
                "10.0.0.15:2022-05-15 12:10:45",
                "172.16.2.5:2022-05-15 13:25:50",
                "192.168.1.30:2022-05-15 14:30:55",
                "10.0.0.7:2022-05-15 15:40:00",
                "172.16.0.8:2022-05-15 16:50:05",
                "192.168.2.15:2022-05-15 17:55:10");
            //string[] actual = workingMethods.ReadLogs(filePath);
        }
    }
}
